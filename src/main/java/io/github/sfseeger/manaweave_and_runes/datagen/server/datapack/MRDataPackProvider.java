...
import io.github.sfseeger.manaweave_and_runes.common.worldgen.structures.MRStructureSets;
import io.github.sfseeger.manaweave_and_runes.common.worldgen.structures.MRStructureTemplatePools;
import io.github.sfseeger.manaweave_and_runes.common.worldgen.structures.MRStructures;
...
public class MRDataPackProvider extends DatapackBuiltinEntriesProvider {
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            ...
            .add(Registries.STRUCTURE, MRStructures::bootstrap)
            .add(Registries.TEMPLATE_POOL, MRStructureTemplatePools::bootstrap)
            .add(Registries.STRUCTURE_SET, MRStructureSets::bootstrap);
