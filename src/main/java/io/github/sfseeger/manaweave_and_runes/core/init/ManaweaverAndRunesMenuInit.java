...
public class ManaweaverAndRunesMenuInit {
    ...
    public static final Supplier<MenuType<LegecyRuneCarverBlockMenu>> RUNE_CARVER_BLOCK_MENU = MENUS.register(
            "rune_carver_menu", () -> new MenuType<>(LegecyRuneCarverBlockMenu::new, FeatureFlags.DEFAULT_FLAGS));
